...
using ActionId = Ui::Actions::KnownActions::Addons;


Addons::Actions::Actions(GCodeWorkShop* parent) :
	Ui::Actions::ActionKit(parent),
	m_app(parent)
{
	...
	connect(makeAction(ActionId::TRANGLE), SIGNAL(triggered()), this, SLOT(doTriangle()));
...
void Addons::Actions::loadTranslations()
{
	...
	setActionText(ActionId::TRANGLE, tr("Solution of triangles"));
	setActionExToolTip(ActionId::TRANGLE, tr("Solution of triangles"));
}
...
void Addons::Actions::loadIcons()
{
	...
	setActionIcon(ActionId::TRANGLE, QIcon(":/images/triangles.png"));
}
...
{
	return action(ActionId::TRANGLE);
}
