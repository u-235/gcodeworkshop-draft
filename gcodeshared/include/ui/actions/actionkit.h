...
#ifndef UI_ACTIONS_ACTIONKIT_H
#define UI_ACTIONS_ACTIONKIT_H
...
public:
	...
	bool isShortcutTipEnabled() const;
	void setShortcutTipEnabled(bool enable);
...
private:
	...
	bool m_shortcutTipEnabled;
	QMap<QString, ActionEx> m_actions;
};
} // namespace Actions
} // namespace Ui

#endif // UI_ACTIONS_ACTIONKIT_H
